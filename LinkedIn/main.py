...
class EasyApplyLinkedin:
    ...
    def login_linkedin(self):
        ...
        login_email = self.driver.find_element(By.CSS_SELECTOR, 'input[name="session_key"]')
        login_email.clear()
        login_email.send_keys(self.email)
        login_pass = self.driver.find_element(By.CSS_SELECTOR, 'input[name="session_password"]')
        login_pass.clear()
